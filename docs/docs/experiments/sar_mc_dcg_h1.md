...
MC power curve — OnlineDCGGLRT vs DCGGLRT under H1 (change detection)

**Tags:** `detection`  `dcg`  `H1`  `monte-carlo`  `power-curve`

## Run

```sh
uv run python 2-detection/sar_experiments/mc_simulations/mc_dcg_h1.py
```
