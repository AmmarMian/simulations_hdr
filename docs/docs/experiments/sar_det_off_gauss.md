...
<span class="sep">/</span>
<span class="here">sar_det_off_gauss</span>
</nav>
...
<span class="kn">from</span><span class="w"> </span><span class="nn">hdrlib.sar.detectors</span><span class="w"> </span><span class="kn">import</span> <span class="n">GaussianGLRT</span>
...
<span class="k">if</span> <span class="vm">__name__</span> <span class="o">==</span> <span class="s2">&quot;__main__&quot;</span><span class="p">:</span>
    <span class="n">parser</span> <span class="o">=</span> <span class="n">argparse</span><span class="o">.</span><span class="n">ArgumentParser</span><span class="p">(</span><span class="s2">&quot;Offline Gaussian GLRT change detection on CPU or GPU backend.&quot;</span><span class="p">)</span>
    ...
    <span class="n">sits_data</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">ascontiguousarray</span><span class="p">(</span><span class="n">sits_np</span><span class="o">.</span><span class="n">transpose</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">3</span><span class="p">,</span> <span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">))</span>  <span class="c1"># (T, p, H, W) — CPU, splits moved to GPU on demand</span>
    ...
    <span class="n">logger</span><span class="o">.</span><span class="n">info</span><span class="p">(</span><span class="s2">&quot;Starting Gaussian GLRT detection...&quot;</span><span class="p">)</span>
    ...
    <span class="n">manager</span> <span class="o">=</span> <span class="p">(</span><span class="n">ImageGPURessourceManager</span> <span class="k">if</span> <span class="n">cfg</span><span class="o">.</span><span class="n">is_gpu</span> <span class="k">else</span> <span class="n">ImageCPURessourceManager</span><span class="p">)(</span>
        ...
        <span class="n">process_one_split</span><span class="o">=</span><span class="n">GaussianGLRT</span><span class="p">(</span><span class="n">cfg</span><span class="o">.</span><span class="n">backend</span><span class="p">)</span><span class="o">.</span><span class="n">compute</span><span class="p">,</span>
    ...
    <span class="n">exporter</span><span class="o">.</span><span class="n">save</span><span class="p">(</span><span class="n">results_np</span><span class="p">,</span> <span class="sa">f</span><span class="s2">&quot;gaussian_</span><span class="si">{</span><span class="n">args</span><span class="o">.</span><span class="n">backend</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">elapsed</span><span class="p">,</span> <span class="n">title</span><span class="o">=</span><span class="s2">&quot;Gaussian GLRT&quot;</span><span class="p">)</span>
    <span class="k">if</span> <span class="n">args</span><span class="o">.</span><span class="n">show_interactive</span><span class="p">:</span>
        <span class="n">plot_glrt_map</span><span class="p">(</span><span class="n">results_np</span><span class="p">,</span> <span class="s2">&quot;Gaussian GLRT&quot;</span><span class="p">)</span>
