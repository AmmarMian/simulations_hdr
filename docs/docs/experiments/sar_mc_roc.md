...
| `--T-list` | str | `5,12,49` | Comma-separated T values at which the ROC is read (default '5,12,49'). |
...
| `--detectors` | str | — | Comma-separated subset of detectors to run (e.g. 'SG-O'). Default: all four. |
| `--debug` | — | — | Tiny configuration (60 trials, T up to 10) to validate the pipeline in seconds. Results are NOT publication grade. |
