...
<span class="sep">/</span>
<span class="here">sar_bench_online_time</span>
</nav>

# sar_bench_online_time

Time benchmark for online Gaussian, DCG and Kronecker detectors (CPU + GPU)

**Tags:** `benchmark`  `time`  `online`  `SAR`
...
<span class="n">RESULTS_DIR</span><span class="o">=</span><span class="s2">&quot;$</span><span class="si">{SCRIPT_DIR}</span><span class="s2">/benchmark_online_results&quot;</span>
...
<span class="n">SCRIPT_GAUSSIAN</span><span class="o">=</span><span class="s2">&quot;$</span><span class="si">{SCRIPT_DIR}</span><span class="s2">/../compute_detection_real_data/online_gaussian.py&quot;</span>
<span class="n">SCRIPT_DCG</span><span class="o">=</span><span class="s2">&quot;$</span><span class="si">{SCRIPT_DIR}</span><span class="s2">/../compute_detection_real_data/online_dcg.py&quot;</span>
<span class="n">SCRIPT_KRONECKER</span><span class="o">=</span><span class="s2">&quot;$</span><span class="si">{SCRIPT_DIR}</span><span class="s2">/../compute_detection_real_data/online_kronecker.py&quot;</span>
...
<span class="n">run_benchmark</span> <span class="s2">&quot;cpu_gaussian_no_wavelet&quot;</span> \
  <span class="s2">&quot;uv run python $</span><span class="si">{SCRIPT_GAUSSIAN}</span><span class="s2"> --data-path $</span><span class="si">{DATA}</span><span class="s2"> --window-size $</span><span class="si">{WINDOW_SIZE}</span><span class="s2"> --backend torch-cpu --quiet&quot;</span>

<span class="n">run_benchmark</span> <span class="s2">&quot;cpu_gaussian_wavelet&quot;</span> \
  <span class="s2">&quot;uv run python $</span><span class="si">{SCRIPT_GAUSSIAN}</span><span class="s2"> --data-path $</span><span class="si">{DATA}</span><span class="s2"> --window-size $</span><span class="si">{WINDOW_SIZE}</span><span class="s2"> --backend torch-cpu --wavelet --quiet&quot;</span>

<span class="n">run_benchmark</span> <span class="s2">&quot;cpu_dcg_no_wavelet&quot;</span> \
  <span class="s2">&quot;uv run python $</span><span class="si">{SCRIPT_DCG}</span><span class="s2"> --data-path $</span><span class="si">{DATA}</span><span class="s2"> --window-size $</span><span class="si">{WINDOW_SIZE}</span><span class="s2"> --backend torch-cpu --quiet&quot;</span>

<span class="n">run_benchmark</span> <span class="s2">&quot;cpu_dcg_wavelet&quot;</span> \
  <span class="s2">&quot;uv run python $</span><span class="si">{SCRIPT_DCG}</span><span class="s2"> --data-path $</span><span class="si">{DATA}</span><span class="s2"> --window-size $</span><span class="si">{WINDOW_SIZE}</span><span class="s2"> --backend torch-cpu --wavelet --quiet&quot;</span>

<span class="n">run_benchmark</span> <span class="s2">&quot;cpu_kronecker_wavelet&quot;</span> \
  <span class="s2">&quot;uv run python $</span><span class="si">{SCRIPT_KRONECKER}</span><span class="s2"> --data-path $</span><span class="si">{DATA}</span><span class="s2"> --window-size $</span><span class="si">{WINDOW_SIZE}</span><span class="s2"> --backend torch-cpu --wavelet --quiet&quot;</span>

<span class="c1"># ---- GPU benchmarks ----------------------------------------------------------</span>
<span class="n">run_benchmark</span> <span class="s2">&quot;gpu_gaussian_no_wavelet&quot;</span> \
  <span class="s2">&quot;uv run python $</span><span class="si">{SCRIPT_GAUSSIAN}</span><span class="s2"> --data-path $</span><span class="si">{DATA}</span><span class="s2"> --window-size $</span><span class="si">{WINDOW_SIZE}</span><span class="s2"> --backend torch-cuda --splitting (1,1) --quiet&quot;</span>

<span class="n">run_benchmark</span> <span class="s2">&quot;gpu_gaussian_wavelet&quot;</span> \
  <span class="s2">&quot;uv run python $</span><span class="si">{SCRIPT_GAUSSIAN}</span><span class="s2"> --data-path $</span><span class="si">{DATA}</span><span class="s2"> --window-size $</span><span class="si">{WINDOW_SIZE}</span><span class="s2"> --backend torch-cuda --wavelet --splitting (1,1) --quiet&quot;</span>

<span class="n">run_benchmark</span> <span class="s2">&quot;gpu_dcg_no_wavelet&quot;</span> \
  <span class="s2">&quot;uv run python $</span><span class="si">{SCRIPT_DCG}</span><span class="s2"> --data-path $</span><span class="si">{DATA}</span><span class="s2"> --window-size $</span><span class="si">{WINDOW_SIZE}</span><span class="s2"> --backend torch-cuda --splitting (3,3) --quiet&quot;</span>

<span class="n">run_benchmark</span> <span class="s2">&quot;gpu_dcg_wavelet&quot;</span> \
  <span class="s2">&quot;uv run python $</span><span class="si">{SCRIPT_DCG}</span><span class="s2"> --data-path $</span><span class="si">{DATA}</span><span class="s2"> --window-size $</span><span class="si">{WINDOW_SIZE}</span><span class="s2"> --backend torch-cuda --wavelet --splitting (3,3) --quiet&quot;</span>

<span class="n">run_benchmark</span> <span class="s2">&quot;gpu_kronecker_wavelet&quot;</span> \
  <span class="s2">&quot;uv run python $</span><span class="si">{SCRIPT_KRONECKER}</span><span class="s2"> --data-path $</span><span class="si">{DATA}</span><span class="s2"> --window-size $</span><span class="si">{WINDOW_SIZE}</span><span class="s2"> --backend torch-cuda --wavelet --splitting (3,3) --quiet&quot;</span>

<span class="n">echo</span> <span class="s2">&quot;&quot;</span>
<span class="n">echo</span> <span class="s2">&quot;All benchmarks done. Aggregating results and generating chart...&quot;</span>

<span class="n">uv</span> <span class="n">run</span> <span class="n">python</span> <span class="o">-</span> <span class="s2">&quot;$RESULTS_DIR&quot;</span> <span class="o">&lt;&lt;</span><span class="s1">&#39;EOF&#39;</span>
...
<span class="n">csv_path</span> <span class="o">=</span> <span class="n">results_dir</span> <span class="o">/</span> <span class="s2">&quot;benchmark_online_summary.csv&quot;</span>
...
<span class="k">def</span><span class="w"> </span><span class="nf">make_chart</span><span class="p">(</span><span class="n">rows</span><span class="p">,</span> <span class="n">detector_name</span><span class="p">,</span> <span class="n">results_dir</span><span class="p">):</span>
    ...
    <span class="n">ax</span><span class="o">.</span><span class="n">set_title</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Online </span><span class="si">{</span><span class="n">detector_name</span><span class="si">}</span><span class="s2"> detection time (mean ± std)&quot;</span><span class="p">)</span>
    ...
    <span class="n">png_path</span> <span class="o">=</span> <span class="n">results_dir</span> <span class="o">/</span> <span class="sa">f</span><span class="s2">&quot;benchmark_online_</span><span class="si">{</span><span class="n">detector_name</span><span class="o">.</span><span class="n">lower</span><span class="p">()</span><span class="si">}</span><span class="s2">.png&quot;</span>
    ...
    <span class="k">try</span><span class="p">:</span>
        ...
        <span class="n">tex_path</span> <span class="o">=</span> <span class="n">results_dir</span> <span class="o">/</span> <span class="sa">f</span><span class="s2">&quot;benchmark_online_</span><span class="si">{</span><span class="n">detector_name</span><span class="o">.</span><span class="n">lower</span><span class="p">()</span><span class="si">}</span><span class="s2">.tex&quot;</span>
...
<span class="n">make_chart</span><span class="p">([</span><span class="n">r</span> <span class="k">for</span> <span class="n">r</span> <span class="ow">in</span> <span class="n">rows</span> <span class="k">if</span> <span class="s2">&quot;gaussian&quot;</span> <span class="ow">in</span> <span class="n">r</span><span class="p">[</span><span class="s2">&quot;label&quot;</span><span class="p">]],</span> <span class="s2">&quot;Gaussian&quot;</span><span class="p">,</span> <span class="n">results_dir</span><span class="p">)</span>
<span class="n">make_chart</span><span class="p">([</span><span class="n">r</span> <span class="k">for</span> <span class="n">r</span> <span class="ow">in</span> <span class="n">rows</span> <span class="k">if</span> <span class="s2">&quot;dcg&quot;</span> <span class="ow">in</span> <span class="n">r</span><span class="p">[</span><span class="s2">&quot;label&quot;</span><span class="p">]],</span> <span class="s2">&quot;DCG&quot;</span><span class="p">,</span> <span class="n">results_dir</span><span class="p">)</span>
<span class="n">make_chart</span><span class="p">([</span><span class="n">r</span> <span class="k">for</span> <span class="n">r</span> <span class="ow">in</span> <span class="n">rows</span> <span class="k">if</span> <span class="s2">&quot;kronecker&quot;</span> <span class="ow">in</span> <span class="n">r</span><span class="p">[</span><span class="s2">&quot;label&quot;</span><span class="p">]],</span> <span class="s2">&quot;Kronecker&quot;</span><span class="p">,</span> <span class="n">results_dir</span><span class="p">)</span>
...
`2-detection/experiments/sar/sar_bench_online_time.yaml`
