...
|------|------|---------|-------------|
| `--n_samples` | int | `300` | Number of samples drawn per regime. |
...
<span class="marginnote">
  ...
  <code>--n_samples</code> <span class='mn-default'>300</span><br>
...
<div class="exp-log-text">Saved isocontours in /Users/ammarmian/Research/HDR/simulations_hdr/results/context_gaussian_isocontours/run_10/gaussian_isocontours.tex
</div>
</details>
</div>
