...
|------|------|---------|-------------|
| `--iter-max` | int | `5` | Maximum iterations for H0 and H1 natural gradient estimators (default 5). |
| `--tol` | float | `1e-08` | Convergence tolerance for H1 estimator (default 1e-8). |
